...
// High-fidelity SVG of the Official Gizmo Mascot Logo (GIZMO ICON 02)
const mascotSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <defs>
    ...
    <pattern id="stipple" x="0" y="0" width="4" height="4" patternUnits="userSpaceOnUse">
      <circle cx="2" cy="2" r="0.65" fill="#0A3C23" opacity="0.3"/>
    </pattern>
    <!-- Iris gradient -->
    <radialGradient id="irisGrad" cx="38%" cy="32%" r="68%">
      <stop offset="0%" stop-color="#18633B"/>
      <stop offset="65%" stop-color="#07331D"/>
  ...
  <!-- 1. OFFICIAL GIZMO RED SQUIRCLE APP ICON BACKGROUND -->
  <rect width="512" height="512" rx="108" ry="108" fill="#E61C3D"/>

  <!-- Character Artwork Group Clipped or Padded inside App Icon -->
  <g id="gizmo-mascot" transform="translate(256, 266) scale(0.86) translate(-256, -280)">
    
    <!-- DIE-CUT OUTER STICKER BORDER (Crisp white boundary) -->
    <path d="
      M 256, 12
    ...
    <!-- THICK DARK GREEN PERIMETER STROKE (#07361E) -->
    <path d="
      M 256, 22
    ...
    <!-- INNER HAIR SHADOW & CURL SILHOUETTES -->
    <!-- Left outer curls -->
    ...
    <!-- FACE CANVAS (Warm Cream/Ivory #FDF3DE) -->
    <path d="
      M 112, 290
    ...
    <!-- RETRO STIPPLE SHADING ON JAW & CHIN -->
    <path d="
      M 125, 420
    ...
    <!-- FOREHEAD CURLS & BANGS (The iconic Gizmo hair locks) -->
    <path d="
      M 108, 294
    ...
    <!-- EYES (Large, expressive, cartoon anime style) -->
    <!-- Left Eye -->
    <g id="eye-left">
      <!-- Sclera -->
    ...
    <!-- NOSE (Minimalist stylish single line) -->
    ...
    <!-- MUSTACHE STUBBLE (Angled hatch strokes above upper lip) -->
